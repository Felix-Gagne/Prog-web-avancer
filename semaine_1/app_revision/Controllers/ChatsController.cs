...
using app_revision.Data;
using app_revision.Models;
using Microsoft.AspNetCore.Authorization;

namespace app_revision.Controllers
{
    ...
    public class ChatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ImageUrl")] Chat chat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ImageUrl")] Chat chat)
        {
            if (id != chat.Id)
            {
                return NotFound();
